...
- **GenAI Intern at Tavant Technologies** (Summer 2026) — agentic systems and RAG pipelines
...
- Building DevFlow ingestion pipeline (git history + PRs → ChromaDB)
- Deep Learning and Computer Vision coursework — Fall 2026
...
**[DevFlow — Engineering Lifecycle Intelligence Platform](https://github.com/Atharv-Girish-Chaudhary/devflow)** · *March 2026 – present*
**1st Place — Northeastern AI Workshop & Hackathon.** Agentic system that captures engineering knowledge before team members leave and surfaces it when new ones onboard. Design won at hackathon (3-person team); ingestion pipeline (git + PRs) in active build.
