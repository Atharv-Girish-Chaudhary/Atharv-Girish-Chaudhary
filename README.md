...
- Grinding LeetCode and CS 5180 RL theory in parallel
...
**1st Place — Northeastern AI Workshop & Hackathon.** Agentic system that captures engineering knowledge before team members leave and surfaces it when new ones onboard. Built with Claude API, MCP, FastAPI, and ChromaDB; design phase shipped, full build roadmap public.
`Claude API · MCP · FastAPI · ChromaDB · Multi-Agent`
